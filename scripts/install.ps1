...
Write-Host "  1. Get a free Porcupine key at: https://console.picovoice.ai"
Write-Host "  2. Add it to config.yaml -> wake.porcupine_access_key"
Write-Host "     (or skip and use keyboard mode - press Enter to wake)"
